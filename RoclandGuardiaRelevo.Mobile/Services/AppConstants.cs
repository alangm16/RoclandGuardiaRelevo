...
public static class AppConstants
{
    ...
    public static readonly TimeOnly HoraInicioAMS = new(09, 20);
    public static readonly TimeOnly HoraFinAMS = new(09, 25);
    public static readonly TimeOnly HoraInicioBME = new(09, 25);
    public static readonly TimeOnly HoraFinBME = new(09, 30);

    public static readonly TimeOnly HoraInicioAVS = new(09, 35);
    public static readonly TimeOnly HoraFinAVS = new(09, 40);
    public static readonly TimeOnly HoraInicioBVE = new(09, 40);
    public static readonly TimeOnly HoraFinBVE = new(09, 45);
